...
INPUT_PATH="/scratch-shared/mschaffelder/data/finetuning/synthetic/Small/Llama/dolly_test_Llama.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/small/perplexity/ppl_vanilla_llama_8b.jsonl"
