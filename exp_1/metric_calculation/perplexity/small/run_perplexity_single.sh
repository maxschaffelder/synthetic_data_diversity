...
INPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/small/outputs/output_lora_llama_8b_single.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/small/perplexity/ppl_lora_llama_8b_single.jsonl"
