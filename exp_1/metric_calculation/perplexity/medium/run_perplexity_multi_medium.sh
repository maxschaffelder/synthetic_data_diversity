...
INPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/medium/outputs/output_llama_70b_multi_source_medium.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/medium/perplexity/ppl_lora_llama_70b_multi_medium.jsonl"
