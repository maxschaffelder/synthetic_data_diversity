...
INPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/medium/outputs/output_llama_70b_single_source_small.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/medium/perplexity/ppl_lora_llama_70b_single_small.jsonl"
