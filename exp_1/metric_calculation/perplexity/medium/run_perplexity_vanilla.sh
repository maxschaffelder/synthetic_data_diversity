...
INPUT_PATH="/scratch-shared/mschaffelder/data/finetuning/synthetic/Medium/Llama/dolly_test_Llama.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_1/medium/perplexity/ppl_vanilla_llama_70b.jsonl"
