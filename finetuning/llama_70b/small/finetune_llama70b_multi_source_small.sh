...
TRAIN_FILE="/scratch-shared/mschaffelder/data/finetuning/synthetic/Small/Other/dolly_train_all_multi.jsonl" # Path to your training data
OUTPUT_DIR="/scratch-shared/mschaffelder/data/ft_models/llama_70b_multi_source_small" # Output directory for model and logs
