...
TRAIN_FILE="/scratch-shared/mschaffelder/data/finetuning/synthetic/Small/Llama/dolly_train_all_Llama.jsonl" # Path to your training data
OUTPUT_DIR="/scratch-shared/mschaffelder/data/ft_models/llama_70b_single_source_small" # Output directory for model and logs
