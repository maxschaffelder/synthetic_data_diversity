#!/bin/bash
#SBATCH -J finetuning-llama-3.1-70b-multi
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
TRAIN_PATH="/scratch-shared/mschaffelder/data/finetuning/synthetic/Medium/Other/dolly_train_all_multi.jsonl"
VAL_PATH="/scratch-shared/mschaffelder/data/finetuning/synthetic/Medium/Other/dolly_test_multi.jsonl"
RESPONSE_KEY="response_model"
OUTPUT_DIR="/scratch-shared/mschaffelder/data/ft_models/lora_llama_70b_multi"
...
torchrun --nnodes=1 --nproc_per_node=4 --rdzv_backend=c10d --rdzv_endpoint=localhost:29500 finetuning_70b_like_8b.py \
