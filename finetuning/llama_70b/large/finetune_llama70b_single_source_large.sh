...
#SBATCH --job-name=llama70b-single-large   # Assign a descriptive name to the Slurm job
...
echo "Waiting for 6 hours (21600 seconds) to stagger job start..."
sleep 21600
...
TRAIN_FILE="/scratch-shared/mschaffelder/data/finetuning/synthetic/Large/Llama/dolly_train_all_Llama.jsonl" # Path to your training data
OUTPUT_DIR="/scratch-shared/mschaffelder/data/ft_models/llama_70b_single_source_large" # Output directory for model and logs
