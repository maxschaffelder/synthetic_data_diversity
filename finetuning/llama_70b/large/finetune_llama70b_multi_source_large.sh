...
#SBATCH --job-name=llama70b-multi-large   # Assign a descriptive name to the Slurm job
...
echo "Waiting for 4 hours (14400 seconds) to stagger job start..."
sleep 14400
...
TRAIN_FILE="/scratch-shared/mschaffelder/data/finetuning/synthetic/Large/Other/dolly_train_all_multi.jsonl" # Path to your training data
OUTPUT_DIR="/scratch-shared/mschaffelder/data/ft_models/llama_70b_multi_source_large" # Output directory for model and logs
