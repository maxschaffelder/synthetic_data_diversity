#!/bin/bash
#SBATCH -J llama-70b-medium-bf16-multigpu
#SBATCH -t 24:00:00
#SBATCH --ntasks 1
...
# Assumes accelerate_config.yaml is present in the current directory or configured elsewhere
echo "Launching training with accelerate..."
accelerate launch --config_file accelerate_config.yaml finetuning_llama_lora_unsloth.py \
    ...
    --output_dir "/scratch-shared/mschaffelder/data/ft_models/lora_llama_70b_medium_bf16" \
    --run_name "llama_70b_medium_bf16" \
