...
python finetuning_llama_lora.py \
    ...
    --output_dir "/scratch-shared/mschaffelder/Data/ft_models/lora_llama_70b_multi_small_4bit" \
    --run_name "lora_llama_70b_multi_small_4bit" \
