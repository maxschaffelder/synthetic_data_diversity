...
INPUT_PATH="/scratch-shared/mschaffelder/data/finetuning/synthetic/Medium/Other/dolly_train_2_Mistral.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/data_analysis/perplexity/llama_medium/dolly_train_2_Mistral_medium_PPL.jsonl"
