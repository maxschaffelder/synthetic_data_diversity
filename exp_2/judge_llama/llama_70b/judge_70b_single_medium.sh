#!/bin/bash
#SBATCH --job-name=judgement_llama_single
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/judge/inputs/medium/rb/refusalbench_70b_single_source_medium.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_2/judge/outputs/medium/rb"
