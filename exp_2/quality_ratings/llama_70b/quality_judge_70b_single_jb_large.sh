#!/bin/bash
#SBATCH --job-name=quality_judge_70b_single_jb_large
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/inputs/medium/rb_jb/refusalbench_jailbreak_70b_single_source_large.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/outputs/medium/rb_jb"
OUTPUT_FILENAME="rb_jb_70b_single_judged_large.jsonl"
