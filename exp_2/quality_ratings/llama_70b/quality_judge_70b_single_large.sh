#!/bin/bash
#SBATCH --job-name=quality_judge_70b_single_large
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/inputs/medium/rb/refusalbench_70b_single_source_large.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/outputs/medium/rb"
OUTPUT_FILENAME="rb_70b_single_judged_large.jsonl"
