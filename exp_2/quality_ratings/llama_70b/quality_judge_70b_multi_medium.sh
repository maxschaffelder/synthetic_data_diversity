#!/bin/bash
#SBATCH --job-name=quality_judge_70b_multi_medium
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/inputs/medium/rb/refusalbench_70b_multi_source_medium.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/outputs/medium/rb"
OUTPUT_FILENAME="rb_70b_multi_judged_medium.jsonl"
