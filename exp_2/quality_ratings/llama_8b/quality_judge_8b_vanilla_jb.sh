#!/bin/bash
#SBATCH --job-name=quality_judge_8b_vanilla_jb
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/inputs/small/rb_jb/refusalbench_jailbreak_8b_vanilla.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/outputs/small/rb_jb"
OUTPUT_FILENAME="rb_jb_8b_vanilla_judged.jsonl"
