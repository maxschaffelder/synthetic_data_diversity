#!/bin/bash
#SBATCH --job-name=quality_judge_8b_multi
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/quality_judge/inputs/small/rb/refusalbench_8b_multi_source.jsonl"
