...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/judge/inputs/refusalbench_only/judge_input_refusalbench_8b_single_source.jsonl"
OUTPUT_PATH="/scratch-shared/mschaffelder/data/exp_2/judge/outputs/refusalbench_only"
OUTPUT_FILENAME="refusalbench_8b_single_source_judged.jsonl"
