#!/bin/bash
#SBATCH --job-name=judgement_llama_vanilla_jb
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
INPUT_DATA_PATH="/scratch-shared/mschaffelder/data/exp_2/judge/inputs/medium/rb_jb/refusalbench_jailbreak_70b_vanilla.jsonl"
