#!/bin/bash
#SBATCH --job-name=jb_responses_70b_multi_small
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
python ../generate_responses.py \
    ...
    --output_file "/scratch-shared/mschaffelder/data/exp_2/outputs/medium/refusalbench_jailbreak_70b_multi_source_small.jsonl"
