#!/bin/bash
#SBATCH --job-name=rb_responses_70b_single_medium
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
python ../generate_responses.py \
    ...
    --output_file "/scratch-shared/mschaffelder/data/exp_2/outputs/medium/refusalbench_70b_single_source_medium.jsonl"
