#!/bin/bash
#SBATCH --job-name=rb_responses_70b_single_large
#SBATCH --ntasks 1
...
python ../generate_responses.py \
    ...
    --output_file "/scratch-shared/mschaffelder/data/exp_2/outputs/medium/refusalbench_70b_single_source_large.jsonl"
