#!/bin/bash
#SBATCH --job-name=pairwise_llama_70b_human_source
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
python /scratch-shared/mschaffelder/code/exp_3/pairwise_rankings/pairwise_ranking.py \
    ...
    --output_file "/scratch-shared/mschaffelder/data/exp_3/pairwise/medium/outputs/llama_70b_human_source.jsonl" \
    --ranking_markers "a b" \
