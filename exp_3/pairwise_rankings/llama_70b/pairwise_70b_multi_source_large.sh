...
python /scratch-shared/mschaffelder/code/exp_3/pairwise_rankings/pairwise_ranking.py \
    ...
    --lora_model_path "/scratch-shared/mschaffelder/data/ft_models/medium/lora_llama_70b_multi_source_large" \
    --use_lora \
    --input_file "/scratch-shared/mschaffelder/data/exp_3/pairwise/medium/inputs/pairwise_ranking_input_a_b.jsonl" \
    --output_file "/scratch-shared/mschaffelder/data/exp_3/pairwise/medium/outputs/llama_70b_multi_source_large.jsonl" \
    --ranking_markers "a b" \
