#!/bin/bash
#SBATCH --job-name=absolute_70b_single_source_medium
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
python /scratch-shared/mschaffelder/code/exp_3/absolute_ratings/absolute_rating.py \
    ...
    --output_file "/scratch-shared/mschaffelder/data/exp_3/absolute_ratings/medium/llama_70b_single_source_medium.jsonl" \
