#!/bin/bash
#SBATCH --job-name=absolute_70b_human_source
#SBATCH -t 12:00:00
#SBATCH --ntasks 1
...
python /scratch-shared/mschaffelder/code/exp_3/absolute_ratings/absolute_rating.py \
    ...
    --lora_model_path "/scratch-shared/mschaffelder/data/ft_models/medium/llama_70b_human_source" \
    --use_lora \
    --input_file "/scratch-shared/mschaffelder/data/exp_3/absolute/inputs/medium/summaries_all.jsonl" \
    --output_file "/scratch-shared/mschaffelder/data/exp_3/absolute_ratings/medium/llama_70b_human_source.jsonl" \
